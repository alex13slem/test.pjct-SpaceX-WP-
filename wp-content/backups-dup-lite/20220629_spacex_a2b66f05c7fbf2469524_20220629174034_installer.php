...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220629_spacex_a2b66f05c7fbf2469524_20220629174034_archive.zip';
	const ARCHIVE_SIZE		 = '57887697';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'a2b66f0-29174034';
    const SECONDARY_PACKAGE_HASH = 'c6976dd-29174034';
	const VERSION			 = '1.4.7';
